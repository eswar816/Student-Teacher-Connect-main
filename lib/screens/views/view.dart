                          ...
                          child: TextFormField(
                            ...
                            onChanged: (val){
                              setState(() {
                                ...
                                if(dropdownValue == 1){
                                  completeData = dropdownValue.toString() + "-"+dropdownCycle  + "-"+dropdownBranch+"-"+_fileDescription;
                                }else{
                                  completeData = dropdownValue.toString() + "-"+ dropdownSem + "-"+dropdownBranch+"-"+_fileDescription;
                                }
                              });
